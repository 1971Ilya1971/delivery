(function (global, factory) {
  ...
  let global_1 = // eslint-disable-next-line no-undef
  ...
  let document$1 = global_1.document; // typeof document.createElement is 'object' in old IE

  let EXISTS = isObject(document$1) && isObject(document$1.createElement);

  let documentCreateElement = function (it) {
	  return EXISTS ? document$1.document.createElement(it) : {};
  };
  ...
  let ie8DomDefine = !descriptors && !fails(function () {
	  return Object.defineProperty(documentdocument.createElement(`div`), `a`, {
	    get() {
	      return 7;
	    }
	  }).a != 7;
  ...
  let store = global_1[SHARED] || setGlobal(SHARED, {});
	  ...
	  _createClass(Masked, [{
	    ...
	    */
	    ...
	    value: function _appendChar(ch) {
	      ...
	      let details = this._appendCharRaw(ch, flags);
  ...
  let PatternInputDefinition =
	...
	function () {
	  ...
	  function PatternInputDefinition(opts) {
	    ...
	    let mask = opts.mask;
	        let blockOpts = _objectWithoutProperties(opts, [`mask`]);
	  ...
	  _createClass(PatternInputDefinition, [{
	    ...
	    value: function doValidate() {
	      let _this$masked4; let _this$parent;
	  ...
	  _createClass(ChunksTailDetails, [{
	    ...
	    set: function set(state) {
	      let chunks = state.chunks;
	          let props = _objectWithoutProperties(state, [`chunks`]);
	    ...
	    */
	    ...
	    set: function set(state) {
	      let _blocks = state._blocks;
	          let maskedState = _objectWithoutProperties(state, [`_blocks`]);
	    ...
	    value: function doPrepare(str) {
	      ...
	      for (let ci = 0; ci < str.length; ++ci) {
	        ...
	        let _this$boundaries = this.boundaries(nextVal);
	            let _this$boundaries2 = _slicedToArray(_this$boundaries, 2);
	            let minstr = _this$boundaries2[0];
	            let maxstr = _this$boundaries2[1];
	    ...
	    */
	    ...
	    value: function doValidate() {
	      ...
	      let _this$boundaries3 = this.boundaries(str);
	          let _this$boundaries4 = _slicedToArray(_this$boundaries3, 2);
	          let minstr = _this$boundaries4[0];
	          let maxstr = _this$boundaries4[1];
  ...
  MaskedDate.DEFAULTS = {
	  ...
	  parse: function parse(str) {
	    let _str$split = str.split(`.`);
	        let _str$split2 = _slicedToArray(_str$split, 3);
	        let day = _str$split2[0];
	        let month = _str$split2[1];
	        let year = _str$split2[2];
  ...
  let HTMLContenteditableMaskElement =
	/* #__PURE__*/
	  ...
	  */
	  ...
	  _createClass(InputMask, [{
	    ...
	    */
	    ...
	    value: function updateOptions(opts) {
	      let mask = opts.mask;
	          let restOpts = _objectWithoutProperties(opts, [`mask`]);
	  ...
	  */
	  ...
	  _createClass(MaskedDynamic, [{
	    ...
	    */
	    ...
	    key: `doValidate`,
	    value: function doValidate() {
	      let _get2; let _this$currentMask2;
	    ...
	    */
	    ...
	    key: `extractTail`,
	    value: function extractTail() {
	      let _this$currentMask5; let _get3;
	    ...
	    */
	    ...
	    value: function nearestInputPos() {
	      let _this$currentMask6; let _get4;
	    ...
	    */
	    ...
	    set: function set(state) {
	      let compiledMasks = state.compiledMasks;
	          let currentMaskRef = state.currentMaskRef;
	          let currentMask = state.currentMask;
	          let maskedState = _objectWithoutProperties(state, [`compiledMasks`, `currentMaskRef`, `currentMask`]);
